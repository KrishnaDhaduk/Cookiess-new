...
class AppTheme {
  ...
  static Color get infoColor =>
      isLightTheme ? Color(0xFF186DDD) : Color(0xFF186DDD);
  static Color get warningColor =>
      isLightTheme ? Color(0xFFF7DE00) : Color(0xFFF7DE00);
  static Color get dangerColor =>
      isLightTheme ? Color(0xFFE23D24) : Color(0xFFE23D240);
  static Color get googleColor =>
      isLightTheme ? Color(0xFF4285F4) : Color(0xFF4285F4);
  static Color get facebookColor =>
      isLightTheme ? Color(0xFF395998) : Color(0xFF395998);
  static Color get inputColor =>
      isLightTheme ? Color(0xFFF6F8FC) : Color(0xFFF6F8FC);

  static Color get scaffoldBackgroundColor =>
      isLightMode ? Color(0xFFFFFFFF) : Color(0xFF010F07);
  static Color get backgroundColor =>
      isLightMode ? Color(0xFFFFFFFF) : Color(0xFF1F2123);

  static Color get primaryTextColor =>
      isLightMode ? Color(0xFF010F07) : Color(0xFF2F3233);
  ...
  static Color get darkTextColor =>
      isLightTheme ? Color(0xFF010F07) : Color(0xFF1F2123);

  static Color get whiteTextColor =>
      isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF2F3233);

  static Color get lightGrayTextColor =>
      isLightTheme ? Color(0xFF757575) : Color(0xFFADADAD);
